...
Date: 2026-08-21 · Status: Accepted · Source: [#14](https://github.com/okqixiaobao727-design/GPT-VoiceCoding/issues/14)
...
This route depends on launch-time injection and serves the pre-#67 Session definition; the user-scope `PermissionRequest` hook route replaces it once [#71](https://github.com/okqixiaobao727-design/GPT-VoiceCoding/issues/71) proves it.
